...
def bootstrapping(event_times, targets, outputs, metrics_epoch, test_metrics, repeat=1000):
    ...
    for number in range(repeat):
        ...
        for met in metrics_epoch:
            test_metrics.epoch_update(met.__name__, met(event_times_, targets_, outputs_))
